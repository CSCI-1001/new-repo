...
export default function Home() {
  return (
    <div className='container'>
      ...
      <main>
        <h1 className='title'>Welcome to our group's website!</h1>

        <p className='description'>
          Made by Jake Carroll, Justin Goh, and Tanmay Meti
        </p>

        <div className='grid'>
          <a href='/jakeCarroll' className='card'>
            <h3>Jake Carroll's Page</h3>
            <p>Click here to navigate to an Jake's page</p>
          </a>
          <a
            href='/justinGoh'
            className='card'>
            <h3>Justin Goh's Page&rarr;</h3>
            <p>
              Click here to navigate to an Justin's page
            </p>
          </a>
          <a
